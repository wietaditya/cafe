...
<html lang="en">
    <head>
        ...
        <title>Roetin Coffee | home</title>
    ...
    <body>
        ...
        <section class="page-section clearfix">
            <div class="container">
                <div class="intro">
                    <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" style="width:60%" src="assets/img/home1.jpg" alt="..." />
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            ...
                            <p class="mb-0">We're open everyday at 09.00-23.00 ()</p>
							<a href="<?= base_url() ?>about">Find out our location</a>
                        </div>
                    </div>
                </div>
            </div>
